    ...
    <>
      <div className="d-flex justify-content-between flex-column flex-sm-row p-lg-3">
        ...
        <button
          ...
          onClick={displayAddSecretary}
        >
          <i className="bi bi-plus-lg fs-6"></i>Add Secretary
        </button>
      </div>
      {displayAdd && (
        <AddNewSecretary displayAddSecretary={displayAddSecretary} />
      )}

      {displayModify && (
        <ModifySecretary displayModifySecretary={displayModifySecretary} />
      )}
      <div className="p-3 d-flex flex-wrap justify-content-center" id="filterd">
        {vehicles.map((v, i) => (
          <button
            key={i}
            onClick={displayModifySecretary}
...
const ModifySecretary = ({ displayModifySecretary }) => {
  return (
    <div
        ...
        <div className="modal-content">
          <div className="modal-header">
            <h4 className="modal-title" id="Ckeck Form">
              Delete or Modify Secretary information
            </h4>
          </div>
...
const AddNewSecretary = ({ displayAddSecretary }) => {
  return (
    <div
      className="modal fade show d-block"
      id="exampleModalCenter"
