  ...
  return (
    <>
      <div className="d-flex justify-content-between flex-column flex-sm-row p-lg-3">
        ...
        >
          <i className="bi bi-plus-lg fs-6"></i> Add Driver
        </button>
      </div>
      {displayAdd && <AddNewDriver displayAddDriver={displayAddDriver} />}
      ...
      <div className="p-3 d-flex flex-wrap justify-content-center" id="filterd">
        {vehicles.map((v, i) => (
          ...
          >
            <div
              className="img-containe d-flex m-auto justify-content-center align-items-center "
              style={{
                maxHeight: "100%",
                maxWidth: "40%",
              }}
