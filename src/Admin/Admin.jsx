...
export const Admin = () => {
  ...
  const displayModifyAdmin = () => {
    displayModify ? setDisplayModify(false) : setDisplayModify(true);
  };
  const [displayAdd, setDisplayAdd] = useState(false);
  const displayAddAdmin = () => {
    setDisplayAdd(displayAdd ? false : true);
  };
  return (
    // we passed satets methods in value
    <admin.Provider value={{}}>
      <div className="d-flex justify-content-between flex-column flex-sm-row p-lg-3">
        ...
        <button
          ...
          onClick={displayAddAdmin}
        >
          <i className="bi bi-plus-lg fs-6"></i>Add Admin
        </button>
      </div>
      {displayAdd && <AddNewAdmin displayAddAdmin={displayAddAdmin} />}

      {displayModify && <ModifyAdmin displayModifyAdmin={displayModifyAdmin} />}
      <div className="p-3 d-flex flex-wrap justify-content-center" id="filterd">
        {vehicles.map((v, i) => (
          <button
            key={i}
            onClick={displayModifyAdmin}
...
const ModifyAdmin = ({ displayModifyAdmin }) => {
  return (
    <div
        ...
        <div className="modal-content">
          <div className="modal-header">
            <h4 className="modal-title" id="Ckeck Form">
              Delete or Modify Admin information
            </h4>
          </div>
...
const AddNewAdmin = ({ displayAddAdmin }) => {
  return (
    <div
      className="modal fade show d-block"
      id="exampleModalCenter"
